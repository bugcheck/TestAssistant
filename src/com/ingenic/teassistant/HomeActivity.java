...
import com.ingenic.teassistant.workers.*;
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        switch( menuItem.getItemId() ) {
            ...
            case R.id.menu_preferences:
                Intent intent = new Intent(this, com.ingenic.teassistant.MainPreferenceActivity.class);
...
//        intent.setClassName("com.android.contacts", "com.android.contacts.activities.PeopleActivity");
    ...
    protected void slideToNextActivity() {
        Intent intent = new Intent();
        intent.setClassName("com.ingenic.teassistant", "com.ingenic.teassistant.TestActivity");
        startActivity(intent);
    }
